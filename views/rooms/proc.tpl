...
<TMPL_UNLESS inside>
	...
	<br>
	<img src='/img/<TMPL_VAR skin_pic_proc>' width=400>
	<br>
	<br>
...
<TMPL_ELSE>
	...
	<p class=proc_left_time>Осталось <span id='left_time'><TMPL_VAR ban_left_time></span> секунд</p>
	<br>
	<img src='/img/<TMPL_VAR skin_pic_proc>' width=400>
	...
	<!--
		var left_time=<TMPL_VAR ban_left_time>;
