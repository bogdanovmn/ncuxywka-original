...
'#WHO# любят #WHO_ROD#. Доказано НИИ РАМН #^TERM_ROD# #^WHO_ROD#.',
...
'Вы упали прямо на #WHO_ROD#. Смотрите не раздавите, а не то #WHO# обидятся.',
...
'На улице наблюдается лёгкий #BODY_ILLNESS#. Уберегите ваших #WHO_ROD# от этого кошмара!',
...
TERM_ROD => [qw|
	императива вивисекции аллегории аллитерации ассонанса категории дизъюнкции конъюнкции интеграла
	интрузии дифляции дефлорации эмансипации ингаляции прострации когнитивности диссонанса
	турбулентности гиперактивности перетрубации
|],
